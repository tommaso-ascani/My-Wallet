...
public class NotificationService3Day extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        Intent alarmIntent = new Intent(this, AlarmReceiver3Day.class);
        ...
        calendar.setTimeInMillis(event.getTime() - 259200000);
